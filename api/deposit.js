...
module.exports = async function handler(req, res) {
  ...
  if (action === "initiate-targetgrowths") {
    ...
    try {
      ...
      await supabase.from("deposits").update({ provider_response: provider, provider_status: "checkout_created", updated_at: new Date().toISOString() }).eq("reference", reference);
